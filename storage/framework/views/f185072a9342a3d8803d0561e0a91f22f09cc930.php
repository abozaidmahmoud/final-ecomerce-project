<?php if(session('lang')=='ar'): ?>
    <?php echo $__env->make('arabic.shopcard', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php else: ?>
 ...
 <?php 
              ...
              ?>
                ...
                <div class="size15 trans-0-4">
                    <!-- Button -->
                    <button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
                        <a class="text-white" href=<?php echo e(route('cart.checkout')); ?>>Proceed to Checkout</a>
